/*
regimen_attributes_offsets.txt
~~~~~~~~~~~~~~~~~~~~
...
saved to data/b0783_regimens.csv or data/p0783_regimens.csv
*/
...
select regimen = rcs.synonym_display
    ...
    , rc.add_plan_ind
    , powerplan_base_name = pc2.display_description
...
join rcs where rcs.regimen_catalog_id = rc.regimen_catalog_id
    ...
    and ( rcs.synonym_key like 'PED ONC*'
        or rcs.synonym_key like 'PED BMT*')
